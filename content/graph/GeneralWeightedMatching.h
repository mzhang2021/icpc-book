/**
 * Author:
 * Description: $\mathcal O(N^3)$ general weighted matching
 * Source: https://github.com/wesley-a-leung/Resources/blob/main/Content/C%2B%2B/graph/matching/GeneralWeightedMaxMatch.h
 */
